...
public class ExaminationPagerAction extends BaseAction{
    ...
    public String examinationPagerSave(ExaminationPager examinationPager, @RequestParam("examFile") MultipartFile file){
        examSvcImpl.saveExaminationPager(examinationPager, file);
        return "admin/exam/examinationPager";
    }

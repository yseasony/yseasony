...
import org.yseasony.utils.web.ServletUtils;
...
public class JCaptchaFilter implements Filter {
	...
	//默认值定义
	public static final String DEFAULT_FILTER_PROCESSES_URL = "/admin/j_spring_security_check";
	...
	protected void redirectFailureUrl(final HttpServletRequest request, final HttpServletResponse response)
			throws IOException {
		response.getWriter().write("{ success: false, errors: { reason: '-2' }}");

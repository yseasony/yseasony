 ...
 * 
 */
public class DependencyTree<K, T> implements
        Iterable<DependencyTree.Entry<K, T>> {

    private final Map<K, Entry<K, T>> registry;

    // the sorted list of resolved entries.
    // given an element e from that list it is ensured that any element at the
    // left
    ...
    public static class Entry<K, T> {
        ...
        public String toString() {
            return key + " => " + object + " [ resolved: " + isResolved()
                    + " ]";
        }

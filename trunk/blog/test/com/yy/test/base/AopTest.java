...
public class AopTest {   
    ...
    @Pointcut("execution(public void com.yy.test.base.HelloWorld.sayHello(String))")   
    public void helloworld() {   
    }   
  
    @Before("execution(public void com.yy.test.base.HelloWorld.sayHello(String))")   
    ...
    @AfterReturning("com.yy.test.base.AopTest.helloworld()")   
    public void returnSayHello() {   
        System.out.println("method has returned");   
    }   
  
    @Around("com.yy.test.base.AopTest.helloworld()")   

 ...
 * 读取应用配置的类
 * 
 * @author Hujf @createDate 2010-10-30
 */
public final class ResourceUtil {
    ...
    public static WebServer getUrl(final String key, final String ad) {
        ...
        String result = null;
        if (null == msg) {
            result = StringUtils.isBlank(ad) ? esunny.getString("default") : esunny.getString("default") + ad;
        } else {
    ...
    public static class WebServer {
        ...
        public String queryData(String param, String value) {
            if (StringUtils.isBlank(this.domain)) return "";

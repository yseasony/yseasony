...
import org.yseasony.blog.utils.PropertyFilter.MatchType;
 ...
 * @author calvin
 */
public class HibernateDaoImpl<T, PK extends Serializable> extends SimpleHibernateDaoImpl<T, PK> implements HibernateDao<T, PK> {
	/**
